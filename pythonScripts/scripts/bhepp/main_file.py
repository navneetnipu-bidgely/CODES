...
if __name__ == '__main__':
    ...
    create_meters = configs["user_inputs"]["create_meter_enrollment"]
    create_raw_data = configs["user_inputs"]["create_raw_data"]
    create_billing_data = configs["user_inputs"]["create_billing_data"]
